...
function changeRound(i){
  if(i == 0){
    ...
    document.getElementById("human").style.zIndex = "0";
    ...
    document.getElementById("robot").style.zIndex = "1";
  }else{
    ...
    document.getElementById("robot").style.zIndex = "0";
    ...
    document.getElementById("human").style.zIndex = "1";
  }
}
